        ...
        var Leaflet = (function (_TileMap) {
          ...
          function Leaflet(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Leaflet.__proto__ || Object.getPrototypeOf(Leaflet)).call(
                this,
                options,
              ),
            );
            ...
            [
              {
                ...
                value: function createMap() {
                  ...
                  if (!this.options.style) {
                    ...
                    this.tiles = L.tileLayer(this.options.style).addTo(
                      this.map,
                    );
              ...
              },
              {
                ...
                value: function fromLatLngToPixel(position) {
                  if (this.ready) {
                    var containerPoint =
                      this.map.latLngToContainerPoint(position);
                    return {
                      x: containerPoint.x,
                      y: containerPoint.y,
                    };
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var eachFeature = function eachFeature(feature, type) {
          if (
            ...
            feature.hasOwnProperty("coordinates") &&
            feature.geometry.type === type
          ) {
            return feature.geometry.coordinates;
          } else {
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Google = (function (_StaticMap) {
          ...
          function Google(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Google.__proto__ || Object.getPrototypeOf(Google)).call(
                this,
                options,
              ),
            );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Mapbox = (function (_StaticMap) {
          ...
          function Mapbox(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Mapbox.__proto__ || Object.getPrototypeOf(Mapbox)).call(
                this,
                options,
              ),
            );
            ...
            [
              ...
              },
              {
                ...
                value: function createImage() {
                  ...
                  this.imgUrl +=
                    this.options.lng + "," + this.options.lat + ",";
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var Mapquest = (function (_StaticMap) {
          ...
          function Mapquest(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (Mapquest.__proto__ || Object.getPrototypeOf(Mapquest)).call(
                this,
                options,
              ),
            );
                  ...
                  google.maps.event.addListener(
                    ...
                    function () {
                      ...
                      var offsetX = -Math.round(
                        _this2.canvas.width / pixels - center.x,
                      );
                      var offsetY = -Math.round(
                        _this2.canvas.height / pixels - center.y,
                      );
                      var cvs =
                        _this2.canvas.getContext("webgl") ||
                        _this2.canvas.getContext("2d");
                      cvs.canvas.style.transform =
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        var MapboxGL = (function (_TileMap) {
          ...
          function MapboxGL(options) {
            ...
            var _this = _possibleConstructorReturn(
              this,
              (MapboxGL.__proto__ || Object.getPrototypeOf(MapboxGL)).call(
                this,
                options,
              ),
            );
                ...
                value: function createMap() {
                  ...
                  if (this.options.opacity) {
                    document.getElementsByClassName(
                      "mapboxgl-canvas",
                    )[0].style.opacity = this.options.opacity;
                  }
